...
| `tonnage`      | What it moves, once the service has read the cells. `0` where it moves nothing.                   |
...
draws relative to now moves with the simulated clock even under a fixed seed.
