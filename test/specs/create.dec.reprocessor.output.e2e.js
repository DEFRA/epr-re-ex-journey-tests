...
test.describe('Marking a PRN as December Waste (Reprocessor Output)', () => {
  test('Should show the December waste question for an output reprocessor and record Yes @decWaste @createDecPRNOutput', async ({
    ...
    // A low, fixed tonnage rather than the 203t default: the fixture's rows
    // are randomised (generateOutputReprocessedRow), so its total available
    // balance isn't guaranteed to clear 203t, but comfortably clears this.
