...
export const config = {
  ...
  baseUrl: `https://epr-re-ex-journey-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `epr-re-ex-journey-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `epr-re-ex-journey-tests-${process.env.ENVIRONMENT}`
        },
